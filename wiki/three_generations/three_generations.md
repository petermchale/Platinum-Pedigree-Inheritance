...
All line numbers refer to commit `c333411`. As in the other
walkthrough pages, each function link is followed by its call site in
the driver — `main()` in
[`map_builder.rs`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L989) — so you can step through the
...
- **Kid3** (already carrying a G1-ancestral A→B transition on her
  ...
  [`Iht::new`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/iht.rs#L172) (driver calls at
  [`map_builder.rs:1059`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L1059) for the master template
  and [`map_builder.rs:1111`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L1111) for each VCF site).
...
branch, so [`Iht::new`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/iht.rs#L172) (called from the driver
at [`map_builder.rs:1059`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L1059) and
[`map_builder.rs:1111`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L1111)) hands him the next
...
[`ped.rs`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/ped.rs)).
...
[`track_alleles_through_pedigree`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L295) (driver call at
[`map_builder.rs:1116`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L1116)), that handled G1→G2 now
handles G2→G3. For each (parent, spouse) pair it calls
[`unique_allele`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L243) (invoked from inside the walk
at [`map_builder.rs:315`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L315)) to find alleles that
...
[`get_iht_markers`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L274) (called from inside the walk
at [`map_builder.rs:328`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L328)) reads Kid3's
...
[`collapse_identical_iht`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L385) (driver call at
[`map_builder.rs:1191`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L1191)),
[`fill_missing_values`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L617) (driver call at
[`map_builder.rs:1200`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L1200)),
[`fill_missing_values_by_neighbor`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L540) (driver call
at [`map_builder.rs:1201`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L1201)), and
[`perform_flips_in_place`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L702) (driver calls at
[`map_builder.rs:1135`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L1135),
[`map_builder.rs:1193`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L1193), and
[`map_builder.rs:1203`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L1203)) — run on the G3 trace
...
[`summarize_child_changes`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L673) (driver call at
[`map_builder.rs:1228`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L1228)). The raw output
...
[`collapse_identical_iht`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L385),
[`fill_missing_values`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L617), and
[`fill_missing_values_by_neighbor`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L540) do in the
...
[`get_iht_markers`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/c333411a178de588dc52125fff494830c95605f3/code/rust/src/bin/map_builder.rs#L274) rather than recomputing them
