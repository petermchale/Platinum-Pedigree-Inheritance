...
All line numbers refer to commit `b730e14`. As in the other
walkthrough pages, each function link is followed by its call site in
the driver — `main()` in
[`map_builder.rs`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/b730e145cb7a45200acdc2bf77a2c72046305cf2/code/rust/src/bin/map_builder.rs#L989) — so you can step through the
...
branch, so [`Iht::new`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/b730e145cb7a45200acdc2bf77a2c72046305cf2/code/rust/src/iht.rs#L172) (called from the driver
at [`map_builder.rs:1059`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/b730e145cb7a45200acdc2bf77a2c72046305cf2/code/rust/src/bin/map_builder.rs#L1059) and
[`map_builder.rs:1111`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/b730e145cb7a45200acdc2bf77a2c72046305cf2/code/rust/src/bin/map_builder.rs#L1111)) hands him the next
...
[`ped.rs`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/b730e145cb7a45200acdc2bf77a2c72046305cf2/code/rust/src/ped.rs)).
...
[`map_builder.rs:1116`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/b730e145cb7a45200acdc2bf77a2c72046305cf2/code/rust/src/bin/map_builder.rs#L1116)), that handled G1→G2 now
handles G2→G3. For each (parent, spouse) pair it calls
[`unique_allele`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/b730e145cb7a45200acdc2bf77a2c72046305cf2/code/rust/src/bin/map_builder.rs#L243) (invoked from inside the walk
at [`map_builder.rs:315`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/b730e145cb7a45200acdc2bf77a2c72046305cf2/code/rust/src/bin/map_builder.rs#L315)) to find alleles that
...
at [`map_builder.rs:328`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/b730e145cb7a45200acdc2bf77a2c72046305cf2/code/rust/src/bin/map_builder.rs#L328)) reads Kid3's
...
[`map_builder.rs:1191`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/b730e145cb7a45200acdc2bf77a2c72046305cf2/code/rust/src/bin/map_builder.rs#L1191)),
...
[`map_builder.rs:1200`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/b730e145cb7a45200acdc2bf77a2c72046305cf2/code/rust/src/bin/map_builder.rs#L1200)),
[`fill_missing_values_by_neighbor`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/b730e145cb7a45200acdc2bf77a2c72046305cf2/code/rust/src/bin/map_builder.rs#L540) (driver call
at [`map_builder.rs:1201`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/b730e145cb7a45200acdc2bf77a2c72046305cf2/code/rust/src/bin/map_builder.rs#L1201)), and
[`perform_flips_in_place`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/b730e145cb7a45200acdc2bf77a2c72046305cf2/code/rust/src/bin/map_builder.rs#L702) (driver calls at
...
[`map_builder.rs:1203`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/b730e145cb7a45200acdc2bf77a2c72046305cf2/code/rust/src/bin/map_builder.rs#L1203)) — run on the G3 trace
...
[`map_builder.rs:1228`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/b730e145cb7a45200acdc2bf77a2c72046305cf2/code/rust/src/bin/map_builder.rs#L1228)). The raw output
