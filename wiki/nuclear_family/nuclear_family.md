...
it. All line numbers refer to commit `fa91c0e`.
...
[`Iht::new`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/iht.rs#L172), which hands each founder a fresh
...
[`is_indel`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L501).
...
For each VCF record,
[`track_alleles_through_pedigree`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L295) walks the
pedigree in ancestor-first depth order and, for every `(parent, spouse)`
pair, calls [`unique_allele`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L243) to ask whether the
...
[`get_iht_markers`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L274) reads the parent's already-
...
1. [`backfill_sibs`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L804) uses the fact that siblings
   ...
   noisy regions.
2. [`collapse_identical_iht`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L385) merges adjacent
   sites with compatible letter assignments into blocks, while
   [`fill_missing_values`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L617) and
   [`fill_missing_values_by_neighbor`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L540) fill the
   `.` gaps visible in Panel C from flanking blocks.
3. [`count_matching_neighbors`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L935) and
   [`mask_child_alleles`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L970) identify isolated runs
...
4. [`perform_flips_in_place`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L702) enforces consistent
...
[`summarize_child_changes`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L673).
...
[`Iht::founder_phase_orientations`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/iht.rs#L492), maps letters
to VCF alleles via [`assign_genotypes`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/iht.rs#L442), and picks
