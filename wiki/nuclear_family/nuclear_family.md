...
it. All line numbers refer to commit `ef5f7d2`. Each function link is
followed by its call site in the driver — `main()` in
[`map_builder.rs`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L989) for `gtg-ped-map`, and `main()` in
[`gtg_concordance.rs`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/gtg_concordance.rs#L315) for `gtg-concordance` —
...
At program startup, [`Iht::new`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/iht.rs#L172) (driver calls at
[`map_builder.rs:1059`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L1059) for the master template
and [`map_builder.rs:1111`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L1111) for each VCF site)
...
[`track_alleles_through_pedigree`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L295) then *mutates*
...
[`map_builder.rs:1086`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L1086)), which changes how
...
[`is_indel`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L501), invoked from the VCF-reading loop at
[`map_builder.rs:164`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L164) inside `parse_vcf` (the
driver calls `parse_vcf` at [`map_builder.rs:1092`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L1092)).
...
involved —
[`track_alleles_through_pedigree`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L295) (driver call at
[`map_builder.rs:1116`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L1116)) and
[`backfill_sibs`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L804) (driver call at
[`map_builder.rs:1122`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L1122)) — are called once per
...
[`track_alleles_through_pedigree`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L295) walks the
...
[`map_builder.rs:315`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L315)) to ask whether the parent
...
group: at [`map_builder.rs:333`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L333) it calls
[`find_valid_char`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L285), which returns the *first
...
parents are founders, and [`Iht::new`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/iht.rs#L172) gave dad
...
[`backfill_sibs`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L804) is then called for the same
...
— plus a [multi-child guard](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L818) that disables it for
one-child families.

**Step 3a — backfill non-carriers**
([fill loop at `map_builder.rs:848`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L848)). For every
...
([`map_builder.rs:881`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L881)). The motivation: assume
...
[`map_builder.rs:1135`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L1135) runs between this
state and the marker-file write at
[`map_builder.rs:1142`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L1142), reconciling
...
haplotypes: [`collapse_identical_iht`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L385)
groups each run of sites with the same partition into a block,
and [`perform_flips_in_place`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L702) then chooses
...
[`perform_flips_in_place`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L702). Walking the
vector in order, it compares each entry to its previous neighbor
and, for each founder, picks the `A`/`B` orientation that
minimizes [`count_mismatches`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L791) — the number
...
[`map_builder.rs:1191`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L1191)) then merges
...
[`fill_missing_values`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L617) (driver call at
...
[`fill_missing_values_by_neighbor`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L540) (driver
call at [`map_builder.rs:1201`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L1201)) further
...
[`map_builder.rs:1187`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L1187)) find isolated runs
...
[`map_builder.rs:1135`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L1135) (whose output the
marker file records), after collapse at
[`map_builder.rs:1193`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L1193), and again after
gap-fill at [`map_builder.rs:1203`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L1203) — so
...
by [`summarize_child_changes`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L673) (driver call
at [`map_builder.rs:1228`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L1228)).
...
[`Iht::founder_phase_orientations`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/iht.rs#L492) (driver call
at [`gtg_concordance.rs:256`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/gtg_concordance.rs#L256)), maps letters
to VCF alleles via [`assign_genotypes`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/iht.rs#L442) (driver
call at [`gtg_concordance.rs:267`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/gtg_concordance.rs#L267)), and
...
[`track_alleles_through_pedigree`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L295). The
...
[`perform_flips_in_place`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L702) then aligns those
...
[`summarize_child_changes`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/ef5f7d26aacdb2aa7cf9c5d0bd428ba103626442/code/rust/src/bin/map_builder.rs#L673) emits to
