...
commit `fa91c0e`; permalinks are given in square brackets.
...
- A **PED file** describing the pedigree
  ([`code/rust/src/ped.rs`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/ped.rs)).
...
read time (`is_indel` [`map_builder.rs:501`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L501)).
...
([`iht.rs:172`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/iht.rs#L172)), which assigns a pair of capital letters
...
([`map_builder.rs:295`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L295)) walks individuals in
ancestor-first depth order (`family.get_individual_depths()`). For each
(parent, spouse) pair in the walk, `unique_allele`
([`map_builder.rs:243`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L243)) checks whether the parent has an
...
`get_iht_markers` ([`map_builder.rs:274`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L274)) simply reads
...
([`map_builder.rs:804`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L804)) infers the other founder
...
([`map_builder.rs:385`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L385)). Because each founder's two
...
([`map_builder.rs:702`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L702)) walks the block list and swaps
...
`fill_missing_values_by_neighbor` ([`map_builder.rs:617`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L617),
[`:540`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L540)) using flanking blocks.
...
([`map_builder.rs:935`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L935)) scans each individual's
per-site letters and identifies runs shorter than `--run` (default 10
markers). `mask_child_alleles`
([`map_builder.rs:970`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L970)) then sets the offending slots
...
([`map_builder.rs:673`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L673)) writes per-individual letter
...
([`gtg_concordance.rs:252`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/gtg_concordance.rs#L252)) enumerates the 2^F
founder phase orientations produced by `Iht::founder_phase_orientations`
([`iht.rs:492`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/iht.rs#L492)). Each orientation swaps the order of
...
`assign_genotypes` ([`iht.rs:442`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/iht.rs#L442)) then produces the
...
([`gtg_concordance.rs:213`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/gtg_concordance.rs#L213)), and the orientation with
...
([`gtg_concordance.rs:509`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/gtg_concordance.rs#L509)).
...
([`gtg_concordance.rs:507`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/gtg_concordance.rs#L507)). The list of offending
...
([`map_builder.rs:935`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L935),
[`:970`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L970)) recognises runs shorter than `--run` (default
...
([`map_builder.rs:217`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L217)) drops any site where a sample is
...
([`map_builder.rs:702`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L702)) resolves this by comparing each
...
([`map_builder.rs:804`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L804)) uses the fact that if one child
...
`track_alleles_through_pedigree` ([`map_builder.rs:346-373`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/bin/map_builder.rs#L346))
and `Iht::new`
([`iht.rs:181-185`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/fa91c0e2d66a295ac190b8652920a3327f868433/code/rust/src/iht.rs#L181)). Males receive a single non-dot
