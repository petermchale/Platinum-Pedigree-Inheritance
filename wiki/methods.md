...
([`map_builder.rs`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L989)) and `gtg-concordance`
([`gtg_concordance.rs`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/gtg_concordance.rs#L315)) — that share a common
...
All line numbers refer to commit `a1267bf`; every function link is
...
- A **PED file** describing the pedigree, parsed by
  [`code/rust/src/ped.rs`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/ped.rs). Each row declares an individual's
...
time by [`is_indel`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L501) (invoked from the VCF-reading loop
at [`map_builder.rs:164`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L164) inside `parse_vcf`; the driver
calls `parse_vcf` at [`map_builder.rs:1092`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1092)).
...
At startup the driver calls [`Iht::new`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/iht.rs#L172) once to build a
master inheritance template
([`map_builder.rs:1059`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1059)) that fixes the founder
...
[`legend()`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/iht.rs#L330) is read, to print the column header
...
[`map_builder.rs:1111`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1111) to allocate a fresh `local_iht`
that [`track_alleles_through_pedigree`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L295) then *mutates* in
...
2. **Zygosity is per-chromosome.** The master is hard-coded to
   ...
   [`map_builder.rs:1086`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1086)), which changes how letters
...
For every VCF record, [`track_alleles_through_pedigree`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L295)
(driver call at [`map_builder.rs:1116`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1116)) walks
...
[`unique_allele`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L243) (from inside the walk at
[`map_builder.rs:315`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L315)) to test whether the parent
...
[`get_iht_markers`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L274) (invoked from inside the walk at
[`map_builder.rs:328`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L328)) is the routine that performs the
...
at a given site, [`backfill_sibs`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L804) (driver call at
[`map_builder.rs:1122`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1122)) infers the other founder
...
[`collapse_identical_iht`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L385) (driver call at
[`map_builder.rs:1191`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1191)). A block is a maximal run of
...
continuous. [`perform_flips_in_place`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L702) resolves this by
...
[`map_builder.rs:1135`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1135) (before block collapse),
[`map_builder.rs:1193`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1193) (after block collapse), and
[`map_builder.rs:1203`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1203) (after gap fill) — so that each
subsequent step sees consistently-oriented labels.

Gaps left by `?` slots (depth-filtered sites, backfilled misses) are
then filled by [`fill_missing_values`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L617) (driver call at
[`map_builder.rs:1200`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1200)) and
[`fill_missing_values_by_neighbor`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L540) (driver call at
[`map_builder.rs:1201`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1201)), which propagate letters from
...
[`count_matching_neighbors`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L935) (driver call at
[`map_builder.rs:1172`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1172)) scans each individual's
per-site letter sequence and flags runs shorter than `--run` (default
10 markers) whose flanking letters agree.
[`mask_child_alleles`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L970) (driver call at
[`map_builder.rs:1187`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1187)) then sets those slots back to
...
[`summarize_child_changes`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L673) (driver call at
[`map_builder.rs:1228`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1228)) walks each individual's block
...
The driver [`main()`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/gtg_concordance.rs#L315) reads the block map with
[`parse_ihtv2_file`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/iht.rs#L606) (driver call at
[`gtg_concordance.rs:405`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/gtg_concordance.rs#L405)) and, for each block, fetches
...
[`gtg_concordance.rs:437`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/gtg_concordance.rs#L437). Each record is then phased
...
`{prefix}.fail.vcf` at [`gtg_concordance.rs:444`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/gtg_concordance.rs#L444)
(low-quality) and [`gtg_concordance.rs:450`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/gtg_concordance.rs#L450) (no-call),
and never enter the orientation search.

### 3.1 Orientation search

For every record that clears the input filters,
[`find_best_phase_orientation`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/gtg_concordance.rs#L252) (driver call at
[`gtg_concordance.rs:454`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/gtg_concordance.rs#L454)) enumerates the `2^F`
founder-phase orientations produced by
[`Iht::founder_phase_orientations`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/iht.rs#L492) (invoked inside
`find_best_phase_orientation` at
[`gtg_concordance.rs:256`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/gtg_concordance.rs#L256)). An orientation is a choice,
...
Under a given orientation, [`Iht::assign_genotypes`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/iht.rs#L442)
...
[`compare_genotype_maps`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/gtg_concordance.rs#L213) (driver call at
[`gtg_concordance.rs:268`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/gtg_concordance.rs#L268)), which counts the number
...
- **Zero mismatches**: the winning orientation explains every sample's
  ...
  re-applied via [`Iht::assign_genotypes`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/iht.rs#L442) on the
  passing branch at [`gtg_concordance.rs:514`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/gtg_concordance.rs#L514) — to
  rewrite the record as phased (`0|1`, paternal first) and write it to
  `{prefix}.pass.vcf` at
  [`gtg_concordance.rs:534`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/gtg_concordance.rs#L534).
- **Non-zero mismatches under every orientation**: no assignment of
  ...
  **impossible** under the current block labels. The driver takes the
  ...
  [`gtg_concordance.rs:487`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/gtg_concordance.rs#L487) to identify the offending
  samples — and writes the unphased record to `{prefix}.fail.vcf` at
  [`gtg_concordance.rs:507`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/gtg_concordance.rs#L507). The offending sample
...
[`count_matching_neighbors`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L935) /
[`mask_child_alleles`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L970) pair (driver calls at
[`map_builder.rs:1172`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1172) and
[`map_builder.rs:1187`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1187)) recognises runs shorter than
...
[`depth_filters`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L217) drops any site where a sample is below
...
underlying biology is continuous. [`perform_flips_in_place`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L702)
...
times — [`map_builder.rs:1135`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1135),
[`map_builder.rs:1193`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1193), and
[`map_builder.rs:1203`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1203) — once before collapse, once
...
noisy regions. [`backfill_sibs`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L804) (driver call at
[`map_builder.rs:1122`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1122)) uses the fact that if one
...
[`summarize_child_changes`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L673) (driver call at
[`map_builder.rs:1228`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L1228)) reports every letter
...
[`track_alleles_through_pedigree`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L346) and
[`Iht::new`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/iht.rs#L181). Males receive a single non-dot letter on
...
[`perform_flips_in_place`](https://github.com/Platinum-Pedigree-Consortium/Platinum-Pedigree-Inheritance/blob/a1267bf13b1d821e804295a3bb7ab4d0579ba3ac/code/rust/src/bin/map_builder.rs#L702) skips X entirely to avoid
